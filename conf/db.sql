...
CREATE TABLE `hi_actinst` (
                              ...
                              `act_type` varchar(64) collate utf8_bin default NULL COMMENT '实例类型',
...
CREATE TABLE `hi_identity_link` (
                                    ...
                                    `proc_inst_id` bigint(64) default NULL COMMENT '流程实例id',
                                    `group_id` varchar(64) collate utf8_bin default NULL COMMENT '组id',
...
-- ----------------------------
-- Table structure for ru_identity_link
-- ----------------------------
DROP TABLE IF EXISTS `ru_identity_link`;
CREATE TABLE `ru_identity_link` (
                                    `id` bigint(20) NOT NULL auto_increment COMMENT '主键id',
                                    `type` varchar(64) collate utf8_bin default NULL COMMENT '类型',
                                    `task_id` bigint(64) default NULL COMMENT '任务ID',
                                    `proc_inst_id` bigint(64) default NULL COMMENT '流程实例id',
...
-- ----------------------------
-- Table structure for ru_process_instance
-- ----------------------------
DROP TABLE IF EXISTS `ru_process_instance`;
CREATE TABLE `ru_process_instance` (
                                       `id` bigint(20) NOT NULL auto_increment COMMENT '主键id',
                                       `key` varchar(64) collate utf8_bin default NULL COMMENT '流程定义key',
                                       `name` varchar(64) collate utf8_bin default NULL COMMENT '名称',
                                       `business_key` varchar(64) collate utf8_bin default NULL,
...
-- ----------------------------
-- Table structure for ru_variable
-- ----------------------------
