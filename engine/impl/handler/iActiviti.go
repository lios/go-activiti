...
type ActivitiConstructor func(entity entity.ExecutionEntity) IActiviti
...
func PerformTaskListener(entity entity.ExecutionEntity, taskName, processKey string) error {
